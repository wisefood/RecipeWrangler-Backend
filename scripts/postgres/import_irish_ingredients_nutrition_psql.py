"""Import Irish composition table CSV into Postgres table nutrients-ingredients-irish."""
...
CSV_PATH = Path(os.getenv("IRISH_INGREDIENTS_CSV", REPO_ROOT / "data/raw/irish/Irish_Comp_Table.csv"))
...
TABLE = os.getenv("NUTRITION_INGREDIENTS_IRISH_TABLE", "nutrients-ingredients-irish")
BATCH_SIZE = int(os.getenv("IRISH_INGREDIENTS_IMPORT_BATCH_SIZE", "1000"))
TRUNCATE = os.getenv("IRISH_INGREDIENTS_TRUNCATE", "1") == "1"
