...
from . import obs_context  # noqa: F401 — referenced by dictConfig
    ...
    logging.config.dictConfig(
        {
            ...
            "formatters": {
                "json": {"()": "recipe_wrangler.api.obs_context.JsonFormatter"},
                "standard": {
                    "()": "recipe_wrangler.api.obs_context.ContextTextFormatter",
