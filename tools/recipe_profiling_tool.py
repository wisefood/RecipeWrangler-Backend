...
def Recipe_Profiling_Tool(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # --- Run both tools with the same payload ---
    ...
    # --- Prepare merged result skeleton ---
    merged: Dict[str, Any] = {
    ...
    # --- Merge details ingredient by ingredient ---
...
# tools/recipe_profiling_tool.py
...
def Recipe_Profiling_Node(state: "State") -> "State":
    ...
    # Merge by index (most reliable given potential name normalization)
